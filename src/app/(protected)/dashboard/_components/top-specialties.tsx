...
const getSpecialtyIcon = (specialty: string) => {
  ...
  if (specialtyLower.includes("fisioterap")) return Activity;
  if (specialtyLower.includes("estética") || specialtyLower.includes("estetica"))
    return Hand;
  if (
    specialtyLower.includes("odontolog") ||
    specialtyLower.includes("dentist")
  )
    return Bone;
  if (specialtyLower.includes("fonoaudiol")) return Stethoscope;
  if (specialtyLower.includes("nutri")) return Activity;
  if (specialtyLower.includes("psicolog")) return Brain;
  if (specialtyLower.includes("enferm")) return Hospital;
  if (specialtyLower.includes("pilates")) return Activity;
  if (specialtyLower.includes("acupuntura")) return Bone;
